"""Analytical equations for D1-to-IL2, D1 > D2.
...
def model_coefficients_d1_greater_d2():
    """Return A11, A22, and the mutual term for the D1 > D2 region."""
    ...
    return a11, a22, mutual_coupling


def solve_dc_operating_point():
    """Solve the screenshot's two D1 > D2 DC equations for IL1 and IL2."""
    a11, a22, mutual_coupling = model_coefficients_d1_greater_d2()
...
def g_il2_d1(frequency_hz, IL1, IL2):
    """Evaluate I_L2_hat(s)/D1_hat(s) at s = j*2*pi*f."""
