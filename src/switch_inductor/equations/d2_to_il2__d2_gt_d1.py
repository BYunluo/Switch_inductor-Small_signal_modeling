"""Analytical equations for D2-to-IL2, D2 > D1.
...
def steady_state_mutual_coupling_d2_greater_d1():
    """Return the mutual polynomial in the supplied D2 > D1 DC equations."""
    return (
        D1 * RB2 * RB3
        - (D2 - D1) * RB1 * RB3
        + (1.0 - D2) * RB1 * RB2
...
def solve_dc_operating_point():
    """Solve the supplied D2 > D1 equations after setting both derivatives to zero."""
...
def g_il2_d2(frequency_hz, IL1, IL2):
    """Evaluate the D2 > D1 form of I_L2_hat(s)/D2_hat(s)."""
