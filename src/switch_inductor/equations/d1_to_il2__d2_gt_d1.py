"""Analytical equations for D1-to-IL2, D2 > D1.
...
def mutual_coupling_d2_greater_d1():
    """Return the mutual-coupling polynomial for the D2 > D1 region."""
    return (
        D1 * RB2 * RB3
        - (D2 - D1) * RB1 * RB3
        + (1.0 - D2) * RB1 * RB2
...
def solve_dc_operating_point():
    """Solve the DC equations using the D2 > D1 mutual-coupling term."""
    a11, a22 = diagonal_model_coefficients()
    mutual_coupling = mutual_coupling_d2_greater_d1()
...
def g_il2_d1(frequency_hz, IL1, IL2):
    """Evaluate the D2 > D1 form of I_L2_hat(s)/D1_hat(s)."""
